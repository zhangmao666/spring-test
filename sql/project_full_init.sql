...
CREATE TABLE IF NOT EXISTS `chat_messages` (
  ...
  `search_query` VARCHAR(500) DEFAULT NULL COMMENT 'Actual search query used',
  `search_status` VARCHAR(32) DEFAULT NULL COMMENT 'Web search execution status',
  `source_payload` LONGTEXT DEFAULT NULL COMMENT 'Serialized search sources payload',
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
